...
// class Student{
//     rollNo:number;
//     name!:string; //null assertion operator this tell that this name will never be null , i will assgin the value to it later
//     // no need of declaring it in the constructor;
...
// let test11 =(stuArr:Student[]):Student[]|string => {
 
//     if(stuArr.length ==0) return "no student available";
 
//     return stuArr.filter(e=> e.marks>50).map(e=>{
//         e.name= e.name.charAt(0).toUpperCase() + e.name.substring(1);
//         return e;
//     });  
// }

// let ans11 = test11([new Student(101,"sfwfe",214)]);
